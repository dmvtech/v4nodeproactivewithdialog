...
const { BotFrameworkAdapter, BotState, MemoryStorage, ConversationState, UserState } = require('botbuilder');
...
const bot = new ProactiveBot(conversationState, userState, botState, adapter);
